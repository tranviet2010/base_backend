...
export const ERROR = {
  // type_service
  TYPE_SERVICE_NOT_FOUND: 'gia hạn | thanh toán một lần không có trong file excel',
  TYPE_SERVICE_NOT_FOUND_IN_DB: 'kiểu dịch vụ không tìm thấy dữ liệu trong file database',
